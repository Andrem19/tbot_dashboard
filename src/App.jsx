...
function formatPositionAge(timestampOpen, nowMs) {
  if (!Number.isFinite(Number(timestampOpen))) return null;

  const diffMs = Math.max(0, nowMs - (Number(timestampOpen) * 1000));
